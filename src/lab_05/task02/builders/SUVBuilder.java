...
import lab_05.task02.Car;
import lab_05.task02.parts.Body;
...
public class SUVBuilder implements Builder {
    private Body body = new Body(Body.Type.SUV, Body.Color.BLACK);
    ...
    public Builder setBodyColor(Body.Color color) {
        this.body = new Body(Body.Type.SUV, color);
        return this;
    }
