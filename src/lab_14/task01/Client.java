...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        adminsAccounts.put("administrator", "1234"); // Too short password
        ...
        Account[] users = {
            ...
            Account.createAdmin("administrator", "1234"), // Too short password
        ...
        AccessHandler accountAccessCheck = new GuestAccessHandler();
        AccessHandler userCheck = new UserAccessHandler(usersAccounts);
        AccessHandler adminCheck = new AdminAccessHandler(adminsAccounts);
        accountAccessCheck.setNext(userCheck);
        userCheck.setNext(adminCheck);

        for (Account user : users) {
            accountAccessCheck.checkAccess(user);
        }
